...
public class ExampleRegistry {
  ...
  public static void onItemsRegistry(final RegistryEvent.Register<Item> event) {
    ...
    r.register(new ItemNut(new Item.Properties()).setRegistryName("chestnut"));
    r.register(new ItemNut(new Item.Properties()).setRegistryName("lingonberry"));
    r.register(new ItemNut(new Item.Properties()).setRegistryName("pineapple"));
    r.register(new ItemNut(new Item.Properties()).setRegistryName("sprucecone"));
